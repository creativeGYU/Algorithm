...
//		        
//		 for(int = 0; int < answer.length; i++) {
//			 player1[i] = player1[i + player1.length];
//		     player2[i] = player2[i + player2.length];
//		     player3[i] = player3[i + player3.length];
//		            
//		     int answer1 = 0;
//		     int answer2 = 0;
//		     int answer3 = 0;
...
//		    	 answer1++;
//		     } else if (answer[i] = player2[i]) {
//		         answer2++;
//		     } else if (answer[i] = player3[i]) {
//		         answer3++;
//		     } 
//		            
//		 }
